...
enum class NavigatorCommand(val actionId: String) {
    ...
    TOGGLE_GENERATED("IdeaVifm.ToggleGeneratedFiles"),
    ...
    EXPAND_LEVEL("IdeaVifm.ExpandLevel"),
    COLLAPSE_LEVEL("IdeaVifm.CollapseLevel"),
    NEXT_ROOT_FOLDER("IdeaVifm.NextRootFolder"),
    PREVIOUS_ROOT_FOLDER("IdeaVifm.PreviousRootFolder"),
